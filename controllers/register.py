...
def get_register(email_error=None, password_error=None, confirm_password_error=None):
	return render_template('register.html', email_error=email_error, password_error=password_error, confirm_password_error=confirm_password_error)
...
def post_register():
  ...
  if plain_text != plain_text_confirm:
    return get_register(None,'password should be same', 'password should be same')
